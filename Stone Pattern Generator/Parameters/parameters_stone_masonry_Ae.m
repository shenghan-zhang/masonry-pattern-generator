...
Lx_wall =3.05; % Widtht of the wall
Ly_wall =3.05; % Height of the wall 
...
% nxy = [0.25, 0.1667];
option = 'uniform';
Lx_ = 0.23;%*ones(1,length(Ly_));
Ly_ = 0.18;%[0.14,0.14,0.14,0.18,0.18,0.18,0.18]; 
nx_ = 0.25;
ny_ = 0.1667;   
...
thres_area_2 = 0.03;
pe_ = [5,5]; %[1.5,3];
len_erosion = [0.01,0.008];%[0.009,0.007];
n_pixels_=140;
...
seuil_area_ = 0.5;
corr_c0 = [0.03,0.01];
corr_sigma = [0.15,0.];%[0.15,0];
a_ = 0.1;
b_ = 0.25;
seuil_contact_ = 0.45;
reordering_method_='angular';%'nearest_neighbor';
end
%% Resampling options
if (~exist('in_dedicated_function','var'))
min_vertices=10; % Minimum number of vertices
l_edges=0.01;%0.05; % if 0, no resmampling 

...
folder='..\Saved_Pictures_temp_martin\D\';
...
epsilon = 0.03; % Geometrical approximation constant
...
% nxy = [0.25, 0.1667];
option = 'uniform';
Ly_ = 0.12;%[0.14,0.14,0.14,0.18,0.18,0.18,0.18]; 
Lx_ = 0.3;%*ones(1,length(Ly_));
nx_ = 0.25;
ny_ = 0.1667;   
